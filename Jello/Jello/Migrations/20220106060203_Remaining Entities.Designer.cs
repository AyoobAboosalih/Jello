...
namespace Jello.Migrations
{
    ...
    [Migration("20220106060203_Remaining Entities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jello.Data.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Jello.Data.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("assignedCompany")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Jello.Data.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Jello.Data.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Jello.Data.Project", b =>
                {
                    b.HasOne("Jello.Data.Company", null)
            ...
            modelBuilder.Entity("Jello.Data.Ticket", b =>
                {
                    b.HasOne("Jello.Data.Project", null)
            ...
            modelBuilder.Entity("TicketUser", b =>
                {
                    b.HasOne("Jello.Data.Ticket", null)
                        .WithMany()
